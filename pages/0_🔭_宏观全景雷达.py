...
ASSET_GROUPS = {
    ...
    "D: 细分赛道 (Themes)": {
        "SMH": "💾 半导体", "IGV": "☁️ 软件", "CIBR": "🛡️ 网络安全",
        "SKYY": "☁️ 云计算", "XBI": "🧬 生科", "ITA": "✈️ 军工",
        "TAN": "☀️ 太阳能", "URA": "☢️ 铀矿", "PAVE": "🛣️ 基建",
        "BOTZ": "🤖 机器人", "QTUM": "⚛️ 量子", "METV": "🥽 元宇宙",
        "AIQ": "🧠 人工智能"
    },
    "E: 固收阶梯 (Fixed Income)": {
        "SHY": "⏳ 1-3年美债", "IEF": "⏳ 7-10年美债", "TLT": "⏳ 20年美债",
        "LQD": "🏢 投资级债", "HYG": "🗑️ 垃圾债", "EMB": "🌏 新兴债",
        "MUB": "🏛️ 市政债", "TIP": "📈 抗通胀债"
    },
    "F: 聪明钱因子 (Factors)": {
        "MTUM": "🚀 动量", "USMV": "🛡️ 低波", "VLUE": "💰 价值",
        "QUAL": "💎 质量", "IWF": "📈 成长", "RSP": "⚖️ 等权"
    }
}
...
if not raw_data.empty:
    ...
    if not df_metrics.empty:
        ...
        with st.sidebar:
            ...
            st.markdown("➡️ **横轴**：估值 (左便宜，右贵)")
            st.markdown("⬆️ **纵轴**：趋势 (上强，下弱)")
        ...
        fig.add_annotation(x=min_x, y=min_y, text="❄️ 弱势超跌", showarrow=False, font=dict(color="#3498DB", size=12))
